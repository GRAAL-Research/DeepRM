...
def train_valid_loaders(dataset, batch_size, splits, drop_last, shuffle=True, seed=42):
    """
    ...
    train_loader = DataLoader(train_dataset, batch_size=batch_size, shuffle=False, drop_last=drop_last)
    valid_loader = DataLoader(valid_dataset, batch_size=batch_size, shuffle=False, drop_last=drop_last)
